        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-2">
            {project.liveLink && (
              <Button
                variant="primary"
                size="sm"
                className="flex-1 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-black font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300"
            ...
            {project.githubLink && (
              <Button
                variant="outline"
                size="sm"
                className="flex-1 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-gray-900 dark:hover:border-white hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800 transform hover:-translate-y-0.5 transition-all duration-300"
          ...
          <div className="flex gap-2">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="flex-1 text-green-600 dark:text-green-400 border-green-200 dark:border-green-800 hover:bg-green-50 dark:hover:bg-green-900/20 hover:border-green-400 dark:hover:border-green-600"
              onClick={() => navigateToContactForm(project.title)}
              icon={
                <svg
                  className="w-4 h-4"
                  fill="none"
