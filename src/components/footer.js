        ...
        <div>
          ...
          <ul class="space-y-4">
            ...
            <li class="flex items-start">
              ...
              <a href="mailto:ndevulion@gmail.com" class="text-gray-400 hover:text-yellow-400 transition-colors">ndevulion@gmail.com</a>
            </li>
            <li class="flex items-start">
              <div class="text-yellow-400 mr-3 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span class="text-gray-400">+250 785044398 Whatsapp only</span>
              <span class="text-gray-400">+250 735007705 call only</span>
            </li>
          </ul>
