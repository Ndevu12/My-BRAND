  ...
  header.innerHTML = `
    <div class="max-w-6xl mx-auto flex items-center justify-between">
      <div class="flex items-center">
        <a href="${indexPath}index.html" class="flex items-center group transition-all duration-300" aria-label="NdevuSpace Home">
          <div class="overflow-hidden rounded-lg mr-2 transform transition-all duration-300 group-hover:scale-105">
            <img src="${imgPath}logo1.png" alt="NdevuSpace Logo" class="w-12 h-12 object-cover">
          </div>
      ...
      <div class="flex items-center gap-4">
        ...
        <nav class="hidden lg:flex items-center space-x-1">
          <a href="${basePath}pages/skills.html" class="nav-link ${isActive('skills.html')}">Skills</a>
          <a href="${createNavLink('#aboutme', true)}" class="nav-link ${isActive('#aboutme')}">About</a>
          <a href="${basePath}pages/blogs.html" class="nav-link ${isActive('blogs.html')}">Blogs</a>
          <a href="${createNavLink('#contactme', true)}" class="nav-link ${isActive('#contactme')}">Contact</a>
          <a href="${basePath}pages/projects.html" class="nav-link ${isActive('projects.html')}">Portfolio</a>
    ...
    <div id="mobile-menu" class="fixed inset-0 bg-black/80 backdrop-blur-sm z-[999] transform translate-x-full transition-transform duration-300 lg:hidden">
      <div class="h-full w-3/4 ml-auto bg-secondary border-l border-gray-800 overflow-y-auto">
        ...
        <nav class="p-4 flex flex-col space-y-4">
          <a href="${indexPath}index.html" class="mobile-nav-link ${isActive('index.html')}">Home</a>
          <a href="${basePath}pages/skills.html" class="mobile-nav-link ${isActive('skills.html')}">Skills</a>
          <a href="${createNavLink('#aboutme', true)}" class="mobile-nav-link ${isActive('#aboutme')}">About</a>
          <a href="${basePath}pages/blogs.html" class="mobile-nav-link ${isActive('blogs.html')}">Blogs</a>
          <a href="${createNavLink('#contactme', true)}" class="mobile-nav-link ${isActive('#contactme')}">Contact</a>
          <a href="${basePath}pages/projects.html" class="mobile-nav-link ${isActive('projects.html')}">Portfolio</a>
          <a href="${basePath}pages/experience.html" class="mobile-nav-link ${isActive('experience.html')}">Experience</a>
        </nav>
      </div>
    </div>
  `;
