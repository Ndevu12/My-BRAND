    ...
    <div class="max-w-6xl mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
        ...
        <div class="flex flex-col items-center md:items-start space-y-4">
          <a href="${isHomePage ? 'index.html' : '../index.html'}" class="flex items-center group mb-4 transition-all duration-300" aria-label="NdevuSpace Home">
            <div class="overflow-hidden rounded-lg mr-3 transform transition-all duration-300 group-hover:scale-105">
              <img src="${basePath}images/logo1.png" alt="NdevuSpace Logo" class="w-14 h-14 object-cover">
            </div>
        ...
        <div>
          ...
          <ul class="space-y-3 footer-links">
            ...
            <li>
              <a href="${basePath}views/skills.html">Skills</a>
            </li>
            <li>
              <a href="${basePath}views/projects.html">Projects</a>
            </li>
            <li>
              <a href="${basePath}views/blogs.html">Blogs</a>
            </li>
            <li>
              <a href="${isHomePage ? '#contactme' : '../index.html#contactme'}">Contact</a>
            </li>
            <li>
              <a href="${basePath}views/experience.html">Experience</a>
            </li>
          </ul>
        </div>
      ...
      <div class="pt-6 border-t border-gray-800">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <p class="text-sm text-gray-500 mb-4 md:mb-0">
            &copy; ${new Date().getFullYear()} NdevuSpace | <a href="${basePath}views/signin.html" class="text-gray-500 hover:text-yellow-400 transition-colors">Ndevu</a> | All rights reserved
          </p>
